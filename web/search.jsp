...
<div id="container">
    <%
        List<Product> productRes = (List<Product>) request.getSession().getAttribute("productRes");
        if (productRes.size()==0) {
    %>
        <h2>Sorry, product doesn't exits!</h2>
    <%
        }
    %>
    ...
    <div id="prod_wrapper">
        <div id="panes">
            <c:forEach var="product" items="${productRes}">
                <div>
