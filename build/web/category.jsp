                ...
                <ul>
                    ...
                    <li class="one-third">
                        ...
                        <p>
                            ...
                            <a title="<%=p.getName()%>" href="images/<%=p.getImage()%>" class="portfolio-item-preview" data- rel="prettyPhoto">
                                <img src="images/<%=p.getImage()%>" alt="" width="210" height="145" class="portfolio-img pretty-box">
