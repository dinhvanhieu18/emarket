...
public class OrderingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (CustomerOrder customerOrder : customerOrderSB.findAll()){
            if (customerOrder.getCustomerId().getCustomerId().equals(customer.getCustomerId()) && (!customerOrder.isCheckoutAdmin())){
        ...
        session.setAttribute("customerOrderings", customerOrders);
        session.setAttribute("orderedProductingss", orderedProductss);
        session.setAttribute("productingss", productss);
