...
public class PurchasedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("customerOrdereds", customerOrders);
        session.setAttribute("orderedProductedss", orderedProductss);
        session.setAttribute("productedss", productss);
