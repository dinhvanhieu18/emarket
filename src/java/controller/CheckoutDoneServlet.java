...
//        "/checkoutAdmin"})
public class CheckoutDoneServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("customerOrderCheckeds", customerOrders);
        session.setAttribute("orderedProductCheckedss", orderedProductss);
        session.setAttribute("productCheckedss", productss);
        session.setAttribute("customerCheckeds", customers);

        request.getRequestDispatcher("checkoutAdminDone.jsp").forward(request, response);
    }
